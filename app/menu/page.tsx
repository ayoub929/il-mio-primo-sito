        ...
        <section className="bg-stone-900 rounded-3xl p-8 md:p-12 border border-white/10 shadow-2xl">
            ...
            <div className="grid grid-cols-1 gap-16">
                ...
                <WineSection title="Bolle Rosate">
                    ...
                    <WineItem name=""Vensame'" vino rose'" producer="Az. Agr. Santa Lucia" desc="dosaggio zero (metodo ancestrale)" price="20" alcohol="11.5" />
                    <WineItem name=""Malibran" rose' extra brut" producer="Az. Agr. Malibran" desc="vino spumante (incrocio Manzoni, raboso)" price="20" alcohol="12" />
                    <WineItem name=""Maso Martis" rose' extra brut" producer="Cantina Maso Martis" desc="biologico millesimato 2021 sboccatura 2024 (Pinot nero)" price="58" alcohol="12.5" />
                    <WineItem name=""Berlucchi 61" Franciacorta rose'" producer="Az. Agr. Guido Berlucchi" desc="sboccatura 2024 (pinot nero, chardonnay)" price="45" alcohol="12.5" />
                    <WineItem name=""Rose' rosa" metodo classico brut" producer="Az. Vinicola Villa Rinaldi" desc="millesimato 2019 sboccatura 2023" price="60" alcohol="12.5" />
                </WineSection>
                ...
                <WineSection title="Rosati">
                    ...
                    <WineItem name=""Rosa'" lagrein rose' DOC 2024" producer="Az. Agr. Abbazia di Novacella – Trentino Alto Adige" price="25" alcohol="13.5" />
